...
# epsilon values to investigate the performance method
epsilon1=0
epsilon2=0.1
epsilon3=0.2
epsilon4=0.3
...
Bandit1.playGame()
epsilon1MeanReward=Bandit1.epsilon1MeanReward

Bandit2 = BanditProblem(actionValues, epsilon2, totalSteps)
Bandit2.playGame()
epsilon2MeanReward=Bandit2.epsilon2MeanReward

Bandit3 = BanditProblem(actionValues, epsilon3, totalSteps)
Bandit3.playGame()
epsilon3MeanReward=Bandit3.epsilon3MeanReward

Bandit4 = BanditProblem(actionValues, epsilon4, totalSteps)
Bandit4.playGame()
epsilon4MeanReward=Bandit4.epsilon4MeanReward
