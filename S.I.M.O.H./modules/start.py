...
def run_hazard_detection():
    ...
    os.system("python /Users/tombo/Documents/CORE/Safetybot/S.I.M.O.H./modules/hazard_detection.py")

def run_path_visualizer():
    """Run the path visualizer script, which opens a matplotlib plot."""
    os.system("python /Users/tombo/Documents/CORE/Safetybot/S.I.M.O.H./modules/path_visualizer.py")
